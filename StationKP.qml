    ...
    ListView {
        ...
        delegate: Rectangle {
            ...
            Text {
                ...
                anchors.topMargin: parent.height * 0.066
                anchors.left: parent.left
                anchors.leftMargin: parent.width * 0.05
                text: qsTr("Destination")
                font.family: "Open Sans Regular"
                font.pixelSize: parent.height * 0.0875
                color: ((1 % pos) === 0) ? "#FFFFFF" : (((2 % pos) === 0) || ((pos % 4) === 2) || ((3 % pos) === 0) || ((pos % 4) === 3))  ? "#000000" : "#FFFFFF"
            }
            ...
            Text {
                ...
                anchors.topMargin: parent.height * 0.033
                anchors.left: parent.left
                anchors.leftMargin: parent.width * 0.05
                text: qsTr(destination)
                font.bold: Font.Bold
            ...
            Text {
                ...
                verticalAlignment: Text.AlignVCenter
                horizontalAlignment: Text.AlignHCenter
                anchors.top: destinationValue.bottom
                anchors.topMargin: parent.height * 0.033
                anchors.left: parent.left
                anchors.leftMargin: parent.width * 0.05
                text: qsTr("Status")
